...
function Landing() {
  ...
  return (
   ...
   <div className='flex justify-center bg-yellow-50 h-screen'>
        <div className='m-10 shadow-2xl bg-neutal-500 rounded-lg h-5/6 '>
            <h1 className='text-3xl m-8 font-medium text-slate-800 text-center '>Welcome to EduWallet - a payments app built for learning purposes! </h1>
